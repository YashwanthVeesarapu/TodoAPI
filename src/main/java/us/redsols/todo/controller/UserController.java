...
public class UserController {
    ...
    // edit user
    @PutMapping("update")
    public ResponseEntity<?> edit(@RequestBody User user, @RequestHeader("Authorization") String token) {
    ...
    public ResponseEntity<?> changePassword(@RequestBody ChangePassword object,
